...
![VisionCCTV System Architecture](docs/diagrams/system-architecture.png)
...
![VisionCCTV Data Flow](docs/diagrams/data-flow.png)
*End-to-end process: Upload → Process → Store → Export → Download*

#### AI Pipelines

![Face Recognition Pipeline](docs/diagrams/face-recognition-pipeline.png)
*YOLOv8 + FaceNet pipeline for accurate face detection and recognition*

![Keyword Search Pipeline](docs/diagrams/keyword-search-pipeline.png)
*CLIP-based keyword search with image and text embedding*

#### Deployment Architecture

![Docker Architecture](docs/diagrams/docker-architecture.png)
